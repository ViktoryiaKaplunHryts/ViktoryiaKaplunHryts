...
## ⚡ Резюме:
[Каплун-Гриц Виктория Владимировна](https://drive.google.com/file/d/1EvZDUIM6OEKk_yl0qfpqC-UvM5yWwshW/view?usp=drivesdk)
...
**Кратко:** Тестирование специализированного банковского ПО для проведения расчетных
межбанковских операций. Проверка взаимодействия с ключевыми внешними ( SWIFT, СПФС, ФНС, ПС БР и т.д.) и внутренними (ЭДО, ЦФТ и т.д.) системами НРД. Тестирование миграции СУБД с Oracle на
Postgres.

📊 Мои обязанности на проекте:

✔ Тестирование десктопного приложения построенного на микросервисной архитектуре. (80% back-end / 20% front-end)

✔ Проведение функционального, регрессионного, UI и E2E тестирования

✔ Тестирование требований

✔ Интеграционное тестирование с внешними и внутренними системами НРД

✔ Анализ логов взаимодействия систем в Graylog для выявления и устранения ошибок
...
✔ Создание и запуск feature-файлов(Gherkin) в Jenkins для автоматизации ключевых процессов (создание и отправка документов, проверка статусов)

✔ Взаимодействие с Kubernetes ( мониторила состояние подов и сервисов, анализировала логи для диагностики ошибок ). Понимание базовых компонентов (Deployment, Pod, Service)

✔ Актуализация тестовой документации и прохождение в DevProm

✔ Подготовка инструкций к тестируемому функционалу

✔ Работа с реляционными СУБД: написание и выполнение SQL-запросов для проверки данных (выборка, JOIN-ы, агрегации)
