...
межбанковских операций. Проверка взаимодействия с ключевыми внешними ( SWIFT, СПФС, ФНС, ЦБ РБ и т.д.) и внутренними (ЭДО, ЦФТ и т.д.) системами НРД. Тестирование миграции СУБД с Oracle на
Postgres.
